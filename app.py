...
#         # Force JSON itinerary if user asks for a trip
#         # if "plan" in user_message.lower() or "trip" in user_message.lower():
#         #     user_message = f"""
...
#         # try:
#         #     trip_data = json.loads(reply)
#         #     reply = ""  # hide JSON from the chat UI
#         # except:
#         #     trip_data = None
#         trip_data = None
...
#         # Only save assistant text replies (not JSON trip plans)
#         if not trip_data:
