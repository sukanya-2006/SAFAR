...
//   "kyoto": { police: "110", ambulance: "119", fire: "119" },
//   "thailand": { police: "191", ambulance: "1554", fire: "199" },
//   "bangkok": { police: "191", ambulance: "1554", fire: "199" },
...
//   "barcelona": { police: "091", ambulance: "112", fire: "080" },
...
//   "mexico city": { police: "911", ambulance: "911", fire: "911" },
...
//   // India cities
//   "goa": { police: "100", ambulance: "102", fire: "101" },
//   "jaipur": { police: "100", ambulance: "102", fire: "101" },
//   "mumbai": { police: "100", ambulance: "102", fire: "101" },
//   "delhi": { police: "100", ambulance: "102", fire: "101" },
//   "kolkata": { police: "100", ambulance: "102", fire: "101" },
//   "udaipur": { police: "100", ambulance: "102", fire: "101" },
//   "manali": { police: "100", ambulance: "102", fire: "101" },
//   "shimla": { police: "100", ambulance: "102", fire: "101" },
//   "ladakh": { police: "100", ambulance: "102", fire: "101" },
//   "sikkim": { police: "100", ambulance: "102", fire: "101" },
// };
...
//   // Show SOS panel immediately with emergency numbers
...
//       <a id="sosHospitalBtn" href="#" target="_blank" class="sos-map-link hospital">🏥 Nearby Hospitals</a>
//       <a id="sosPoliceBtn" href="#" target="_blank" class="sos-map-link police">🚔 Nearby Police Stations</a>
//     </div>
...
//         const hospitalUrl = `https://www.google.com/maps/search/hospitals/@${lat},${lng},15z`;
//         const policeUrl = `https://www.google.com/maps/search/police+stations/@${lat},${lng},15z`;

//         document.getElementById("sosLocating").textContent = "✅ Location found! Tap below to open maps:";
//         document.getElementById("sosHospitalBtn").href = hospitalUrl;
//         document.getElementById("sosPoliceBtn").href = policeUrl;
//         document.getElementById("sosMapBtns").style.display = "flex";
//       },
//       (err) => {
//         // Fallback to destination-based search if GPS denied
//         const hospitalUrl = `https://www.google.com/maps/search/hospitals+in+${encodeURIComponent(destination)}`;
//         const policeUrl = `https://www.google.com/maps/search/police+stations+in+${encodeURIComponent(destination)}`;
